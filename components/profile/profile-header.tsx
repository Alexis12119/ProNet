...
import { MapPin, Calendar, Edit, MessageSquare, UserPlus, Star } from "lucide-react"
                ...
                {averageRating && averageRating > 0 && (
                  <div className="flex items-center space-x-2 mt-2">
                    <div className="flex items-center space-x-1">
                      <Star className={`h-5 w-5 ${getRatingColor(averageRating)} fill-current`} />
                      <span className={`font-semibold ${getRatingColor(averageRating)}`}>
                        {averageRating.toFixed(1)}
                      </span>
                    </div>
                    <span className="text-gray-500">•</span>
                    <span className="text-gray-600">{totalJobs} completed jobs</span>
                    <Link
